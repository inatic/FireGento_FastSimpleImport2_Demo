...
class ImportAddressCsv extends AbstractImportCommand
{
    const IMPORT_FILE = "customer_address.csv";
    ...
    protected function configure()
    {
        ...
        $this->setName('fastsimpleimportdemo:customers:importaddresscsv')
            ->setDescription('Import Addresses from CSV');
        $this->setBehavior(Import::BEHAVIOR_APPEND);
        $this->setEntityCode('customer_address');
